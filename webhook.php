...
define('BOT_TOKEN', '608859090:AAEfZLSUsSZp0uVZ7CFuWezDA9ZGOKWPwas');
...
function processMessage($message) {
  ...
  if (isset($message['text'])) {
    ...
    } else if (strpos($text, "/anisa") === 0) {
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => 'Halo Anisa Fadilah ❤!, Saya adalah robot Dani Hidayat'));
...
define('WEBHOOK_URL', 'https://www.smkn5kabtangerang.sch.id/webhook.php');
